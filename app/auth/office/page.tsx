...
import { User, Lock, Building2, ArrowLeft, Eye, EyeOff } from 'lucide-react'
...
export default function OfficeLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.data.user.role === 'office') {
      ...
      } else if (data.success && data.data.user.role !== 'office') {
